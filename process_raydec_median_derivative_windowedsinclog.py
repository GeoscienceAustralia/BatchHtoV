...
if (len(sys.argv) < 9):
	print "Usage: python htov.py method /path/to/miniSEED/ nfrequencies f_min f_max window_length ko_bandwidths log|lin prefix"
	print "Method is 'raydecwslog'"
	exit(0)

#spectra_method='raydeccwtlin' #sys.argv[1]
spectra_method='raydecwslog' #sys.argv[1]
dr = sys.argv[1]
