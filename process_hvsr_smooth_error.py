...
np.savetxt(saveprefix+'allhv.txt',all_hvsr, header=ko_bandwidthstr)
np.savetxt(saveprefix+'alldhv.txt',all_dhvsr, header=ko_bandwidthstr)
np.savetxt(saveprefix+'allddhv.txt',all_ddhvsr, header=ko_bandwidthstr)
